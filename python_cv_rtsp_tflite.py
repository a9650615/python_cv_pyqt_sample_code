...
cap_send = cv2.VideoCapture('rtspsrc do-rtcp=TRUE location=rtspt://admin:123456@192.168.0.100:554/stream2  ! rtph264depay ! h264parse ! decodebin ! autovideoconvert ! videoconvert ! appsink', cv2.CAP_GSTREAMER)
